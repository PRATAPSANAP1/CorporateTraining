...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 px-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md relative z-10 p-8 border-slate-800 bg-slate-900/60 backdrop-blur-xl hover:-translate-y-0" hover={false}>
        ...
        {emailSent ? (
          <div className="text-center">
            <div className="p-4 rounded-xl bg-slate-800/40 border border-slate-800 text-slate-300 text-sm mb-6 leading-relaxed">
              We have sent a password reset link to <span className="font-bold text-blue-400">{email}</span>. Please check your inbox and spam folders.
            </div>
            <Link
              to="/login"
